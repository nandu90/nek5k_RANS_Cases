...
//+
Transfinite Curve {-14, 22, -27, 6, 12, -24, 25, -8} = 12 Using Progression 1.8;
//+
Transfinite Curve {13, 23, 26, 7} = 16 Using Progression 1.0;
//+
Transfinite Curve {2, 28, 5} = 18 Using Bump 0.01;
//+
Transfinite Curve {11, -15, -20, -1} = 16 Using Progression 1.2;
//+
Transfinite Curve {-10, 16, 21, -19, 3} = 14 Using Progression 1.2;
//+
Transfinite Curve {-9, 17, 29, -18, 4} = 25 Using Progression 1.1;
//+
